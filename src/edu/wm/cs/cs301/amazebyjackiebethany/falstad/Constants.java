...
public class Constants {
	...
	//Colors 
	public enum COLOR {BLACK, BLUE, CYAN, DARKGRAY, GRAY, GREEN, LIGHTGRAY, MAGENTA, ORANGE, PINK, RED, WHITE, YELLOW}; 
	...
	public static int VIEW_HEIGHT = 1184;
	...
	static final int STATE_DEAD = 5; // robot runs out of battery
	
	static int[] NORTH = { 0, -1};
	static int[] EAST = { 1, 0};
	static int[] WEST = {-1, 0};
	static int[] SOUTH = { 0, 1};
}