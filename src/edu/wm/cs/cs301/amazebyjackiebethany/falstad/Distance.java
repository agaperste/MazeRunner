...
public class Distance {
	public static int[][] dists; // matrix of dimension width x height with distance values to the exit of a maze
	...
	public int[] computeDistances(Cells cells) {
		...
		System.out.println("Before get pos");
